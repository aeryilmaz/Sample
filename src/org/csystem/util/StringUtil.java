...
public class StringUtil {
    ...
    public static String getRandomPassword(java.util.Random r, int n)
    {
        if (n < 1)
            return "";
    ...
    {
        return getRandomPassword(new java.util.Random(), n);
    }

    public static String getRandomTextDE(java.util.Random r, int n)
    {
        if (n < 1)
            return "";
    ...
    {
        return getRandomTextDE(new java.util.Random(), n);
    }
